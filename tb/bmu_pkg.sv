...
package bmu_pkg;
  ...
  `include "sequences/zbp/bmu_grev_sequence.sv"
  ...
  `include "sequences/zbb/bmu_cpop_sequence.sv"
  `include "sequences/zbb/bmu_sext_b_sequence.sv"
  `include "sequences/zbb/bmu_max_sequence.sv"
  ...
  `include "tests/zbp/bmu_grev_test.sv"
  ...
  `include "tests/zbb/bmu_cpop_test.sv"
  `include "tests/zbb/bmu_sext_b_test.sv"
  `include "tests/zbb/bmu_max_test.sv"
